...
import type { DeliveryOrderFrequency } from "../types"
import {
  formatCompactDeliveryCount,
  formatDeliveryCount,
} from "../utils/format"
    ...
    <Card className="h-full gap-4 py-5">
      <CardHeader className="px-5 pb-0">
        ...
        <p className="text-3xl font-semibold tracking-tight text-foreground">
          {formatDeliveryCount(orderFrequency.total_orders)}{" "}
        ...
        >
          ...
          >
            ...
            <YAxis
              ...
              axisLine={false}
              tickMargin={8}
              tickFormatter={(value) => formatCompactDeliveryCount(Number(value))}
            />
            <XAxis
              dataKey="label"
              tickLine={false}
            ...
            <ChartTooltip
              ...
              content={
                <ChartTooltipContent
                  hideLabel
                  formatter={(value) => formatDeliveryCount(Number(value))}
                />
              }
            />
            <Area
