...
export function MenuCardList({
  ...
  return (
    <>
      ...
      >
        <Card className="flex flex-col sm:flex-row gap-0 overflow-hidden py-0">
          <div className="relative w-full sm:w-44 h-44 sm:h-auto shrink-0 overflow-hidden rounded-t-2xl sm:rounded-l-2xl bg-muted">
            <Image
