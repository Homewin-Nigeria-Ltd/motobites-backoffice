...
const illustrationMap = {
  ...
  total_delivery: ASSETS.illustrations.deliveryVan,
  active_riders: ASSETS.illustrations.users,
} as const
...
export function DeliverySummaryCards({ kpis }: DeliverySummaryCardsProps) {
  return (
